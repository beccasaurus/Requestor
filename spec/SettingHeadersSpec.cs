...
namespace Requestoring.Specs {
	...
	[TestFixture]
	public class SettingHeadersSpec : Spec {
		...
		[Test]
		public void can_set_user_agent() {
		...
		[Test]
		public void can_set_if_modified_since() {
		...
		[Test]
		public void can_set_referer_or_referrer() {
		...
		// [Test]
		// public void can_set_transferencoding() {
