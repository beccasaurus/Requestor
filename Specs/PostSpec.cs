...
namespace Requestoring.Specs {
    ...
    public class PostSpec : Spec {
		...
		[Test]
		public void can_post_a_string_with_a_particular_content_type() {
		...
		[Test]
		public void can_add_post_data_before_doing_post() {
		...
		[Test]
		public void can_set_post_data_to_string_before_doing_post() {
			var json = "{\"Name\":\"Lander\",\"Breed\":\"APBT\"}";
		...
		[Test]
		public void can_post_multiple_variables() {
		...
		[Test]
		public void can_post_variable_with_nonalphanumeric_characters_in_the_name_using_a_Dictionary() {
		...
		[Test]
		public void can_post_variable_with_nonalphanumeric_characters_in_the_name_using_Vars_which_is_a_Dictionary_alias() {
		...
		[Test]
		public void can_post_and_supply_query_strings() {
		...
		[Test]
		public void can_post_and_supply_query_strings_and_custom_headers() {
			Post("/info", new { 
				foo = "bar", 
